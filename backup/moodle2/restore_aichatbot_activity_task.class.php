...
require_once($CFG->dirroot . '/mod/aichatbot/backup/moodle2/restore_aichatbot_stepslib.php'); // Because it exists (must)
...
class restore_aichatbot_activity_task extends restore_activity_task {
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('aichatbot', array('intro'), 'aichatbot');
